namespace Mediator.Examples
{
    class MainApp
    {
        static void Main()
        {
            ...
            ConcreteColleague3 c3 = new ConcreteColleague3(m); //Added

            m.Colleague1 = c1;
            m.Colleague2 = c2;
            m.Colleague3 = c3; //Added

            m.Send("How are you?", c1);
            m.Send("Fine, thanks", c2);
            m.Send("Hello!", c3); //Added
    ...
    class ConcreteMediator : Mediator
    {
        ...
        private ConcreteColleague3 colleague3; //Added
        ...
        public ConcreteColleague3 Colleague3 //Added
        {
        ...
        public override void Send(string message, Colleague colleague)
        {
            if (colleague == colleague1)
            {
                ...
                colleague3.Notify(message); //Added
            }
            ...
            {
                colleague1.Notify(message);
                colleague2.Notify(message); //Added
            }
        }
    }
